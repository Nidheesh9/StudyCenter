...
function SignupForm() {
  ...
  const handleOnSubmit = (e) => {
    ...
    if (password !== confirmPassword) {
      toast.error("Passwords Do Not Match",{icons:""});
      return
    }
    const signupData = {
      ...formData,
  ...
  return (
    <div>
      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4 mt-6">
        ...
        <div className="flex gap-x-4">
          <label className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg bg-gray-800 p-3 text-[16px] leading-[24px] text-gray-100 placeholder:text-gray-400 focus:outline-none !pr-10"
            />
            <span
        ...
        <button
          type="submit"
          className="mt-6 rounded-[8px] bg-gray-400 py-[8px] px-[12px] text-black font-bold"
        >
          Create Account
        </button>
      </form>

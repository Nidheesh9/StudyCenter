    ...
    <div>
      <section className=" bg-zinc-900 relative">
        <div className=" mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          ...
          <div className="md:flex-row flex-col flex gap-32 mb-5">
      ...
      <section className="border-b border-gray-700 mt-14">
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-gray-500 items-center">
          <Quote />
        </div>
      </section>
          ...
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            ...
            <div className="relative">
              <img
                src={FoundingStory}
                alt=""
                className="shadow-[0_0_20px_0] shadow-[#e28585]"
              />
            </div>
          </div>

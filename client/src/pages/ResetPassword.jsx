          ...
          <form onSubmit={handleOnSubmit}>
            <label className="relative">
              ...
              <input
                ...
                className="full rounded-lg bg-gray-800 p-3 text-[16px] leading-[24px] text-gray-100 placeholder:text-gray-400 focus:outline-none focus:bg-gray-800 w-full !pr-10"
              />
              <span
